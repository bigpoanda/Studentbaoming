...
//上传excel文件并传到数据库
app.post("/admin/student/doexcelpost"       ,admin_router.doexcelpost);
...
app.get ("/admin/course"                    ,admin_router.showAdminCourse);     //显示课程目录
...
// 搜索功能
app.get("/admin/course/search"              ,admin_router.search);
app.get("/student/:xuehao/courses"          ,student_router.getstudentcourses); //Ajax的接口，显示某个学生已经报名的课程编号
app.get("/student/:sid"                     ,student_router.showXuanke)          //显示选课页
app.get ("/revise"                          ,student_router.showRevise);         //修改密码页面
app.get ("/revise/changepw"                 ,student_router.changepw);           //修改密码
